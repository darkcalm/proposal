...
- [ ] Group formation (March 24)
- [ ] Project framework setup (March 31)
- [ ] Technical environment setup (March 31)
- [ ] Timeline planning (March 31)
- [ ] Group coordination setup (March 31)
